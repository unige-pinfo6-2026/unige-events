...
/**
 * Read-only stub of the User entity. comment-service needs auth0_id to
 * detect the self-author case for DELETE, plus displayName + avatarUrl to
 * project authors in CommentDTO. Replaced by REST client to user-service
 * at PR 12.
 */
@Entity
@Table(name = "users")

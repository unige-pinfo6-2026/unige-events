...
/**
 * Read-only stub of the Attendance entity. me-aggregator-service uses
 * {@link #countGroupedByStatus} to enrich each EventDTO returned by
 * {@code GET /users/me/events} with attending / waitlisted counts.
 */
@Entity
@Table(
    name = "attendances",

package ch.unige.events.meaggregator;
...
/**
 * Identity probe for me-aggregator-service. Returned by {@code GET /api/__service}.
...
public class ServiceIdentityResource {
    ...
    public Map<String, String> identity() {
        return Map.of(
            "service", "me-aggregator-service",
            "module", "ch.unige.events:me-aggregator-service",
            "status", "scaffold");
    }
}

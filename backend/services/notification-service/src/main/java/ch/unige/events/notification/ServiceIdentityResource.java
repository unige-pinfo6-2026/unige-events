package ch.unige.events.notification;
...
/**
 * Identity probe for notification-service. Returned by {@code GET /api/__service}.
...
public class ServiceIdentityResource {
    ...
    public Map<String, String> identity() {
        return Map.of(
            ...
            "module", "ch.unige.events:notification-service",
            "status", "scaffold");
    }
}

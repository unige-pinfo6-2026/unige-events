...
| [data-model.md](data-model.md) | Entités JPA (champs, types, contraintes), DTOs, conventions de nommage (camelCase, booléens sans `is`), enums, migrations Flyway |
...
| [dev-guide.md](dev-guide.md) | Prérequis, lancement local, commandes Maven, workflows spec-first et Flyway, conventions de nommage, variables d'environnement |

...
export const FACULTIES = {
  ...
  SOCIAL_SCIENCES: { name: 'Faculté des Sciences de la Société', abbr: 'SdS', logo: EconomyLogo, color: '#fcb000' },
  GSEM: { name: "Faculté d'Économie et de Management", abbr: 'GSEM', logo: SocialSciencesLogo, color: '#425878' },
